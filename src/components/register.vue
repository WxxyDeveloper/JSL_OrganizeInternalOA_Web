      ...
      <div class="container w-full max-w-md mx-auto mt-8 " >
        <div class=" mx-auto bg-white border border-gray-200 rounded-lg shadow p-8 dark:bg-gray-800 dark:border-gray-700">
          ...
          <form class="flex flex-col space-y-5 max-w-sm w-96">
            <div class="mb-5">
              <label for="truename" class="flex items-center space-x-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 18">
            ...
            <div class="mb-5">
              <label for="password" class="flex items-center space-x-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
            ...
            <div class="mb-5">
              <label for="sex" class="flex items-center space-x-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
            ...
            <div class="mb-5">
              <label for="datebirth" class="flex items-center space-x-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
            ...
            <div class="mb-5">
              <label for="work" class="flex items-center space-x-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 21">
            ...
            <div class="mb-5">
              <label for="speciality" class="flex items-center space-x-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
